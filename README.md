...
> 安装提示
>
> 当前 Releases 版本暂未提供开发者签名 / 公证。macOS 在安装或首次打开时，可能会提示“无法验证开发者”、“无法打开”或类似拦截信息。
>
> 可以按下面的方式处理：
>
> 1. 在 Finder 中右键应用，选择“打开”
> 2. 或前往“系统设置 > 隐私与安全性”，在拦截提示下选择“仍要打开”
> 3. 如果仍被隔离属性拦截，可以执行：
>
> ```bash
> xattr -dr com.apple.quarantine /Applications/KeyTip.app
> ```
>
> 这属于未签名分发的常见现象，不代表应用本身已损坏。
